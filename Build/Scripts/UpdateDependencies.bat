...
SET defaulttarget=%LOCALAPPDATA%\Temp\PDQTracker
IF "%remote%" == "" SET remote=git@github.com:GridProtectionAlliance/pdqtracker.git
...
SET targettools=%target%\Source\Applications\PDQTracker\PDQTrackerSetup
