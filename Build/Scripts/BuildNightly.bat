...
@ECHO OFF
"C:\Program Files (x86)\MSBuild\14.0\Bin\MSBuild.exe" PDQTracker.buildproj /p:SkipHelpFiles=true /l:FileLogger,Microsoft.Build.Engine;logfile=PDQTracker.output