--  ----------------------------------------------------------------------------------------------------
--  PDQTracker Data Structures for SQL Server - Gbtc
--
...
--       Script is based on PDQTracker.sql script created by James Ritchie Carroll.
...
USE [master]
GO
CREATE DATABASE [PDQTracker];
GO
ALTER DATABASE [PDQTracker] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [PDQTracker] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [PDQTracker] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [PDQTracker] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [PDQTracker] SET ARITHABORT OFF 
GO
ALTER DATABASE [PDQTracker] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [PDQTracker] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [PDQTracker] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [PDQTracker] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [PDQTracker] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [PDQTracker] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [PDQTracker] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [PDQTracker] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [PDQTracker] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [PDQTracker] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [PDQTracker] SET  ENABLE_BROKER 
GO
ALTER DATABASE [PDQTracker] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [PDQTracker] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [PDQTracker] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [PDQTracker] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [PDQTracker] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [PDQTracker] SET  READ_WRITE 
GO
ALTER DATABASE [PDQTracker] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [PDQTracker] SET  MULTI_USER 
GO
ALTER DATABASE [PDQTracker] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [PDQTracker] SET DB_CHAINING OFF 
GO
-- The next three commented statements are used to create a user with access to the PDQTracker database.
...
--GO
--CREATE ROLE [PDQTrackerManagerRole] AUTHORIZATION [dbo]
--GO
--EXEC sp_addrolemember N'PDQTrackerManagerRole', N'NewUser'
--GO
--EXEC sp_addrolemember N'db_datareader', N'PDQTrackerManagerRole'
--GO
--EXEC sp_addrolemember N'db_datawriter', N'PDQTrackerManagerRole'
--GO
