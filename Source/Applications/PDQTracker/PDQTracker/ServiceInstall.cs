    ...
    public partial class ServiceInstall : InstallerBase
    {
        ...
        protected override void OnSystemSettingsLoaded(XmlDocument configurationFile, XmlNode systemSettingsNode)
        {
            ...
            else
            {
                ...
                companyNameNode.Attributes.Append(CreateAttribute(configurationFile, "description", "The name of the company who owns this instance of the PDQTracker."));
            ...
            else
            {
                ...
                companyAcronymNode.Attributes.Append(CreateAttribute(configurationFile, "description", "The acronym representing the company who owns this instance of the PDQTracker."));
